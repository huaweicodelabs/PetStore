...
public class RecommendFragment extends Fragment {
    ...
    private void initRecyclerData() {
        mItemData.clear();
        VideoBean videoBean = new VideoBean(getString(R.string.video_recommend_1), "");
        mItemData.add(videoBean);
        VideoBean videoBean2 = new VideoBean(getString(R.string.video_recommend_2), "");
        mItemData.add(videoBean2);
        VideoBean videoBean3 = new VideoBean(getString(R.string.video_recommend_3), "");
