...
public class IAPDialog extends DialogFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.iap_dialog, container, false);
        // 初始化View
        initView(view);
        return view;
    }
    ...
    private void initView(View view) {
        view.findViewById(R.id.iap_dialog_continue).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        view.findViewById(R.id.iap_dialog_cancel).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // 取消
                if (mCallback != null) {
