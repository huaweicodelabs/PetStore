...
public class SignOutDialog extends DialogFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.signout_dialog, container, false);
        // 初始化View
        initView(view);
        return view;
    }
    ...
    private void initView(View view) {
        view.findViewById(R.id.signout_yes).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        view.findViewById(R.id.signout_no).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // 不退出华为账号
                if (mCallback != null) {
